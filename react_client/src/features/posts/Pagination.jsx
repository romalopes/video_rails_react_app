...
function Pagination({ currentPage, totalPosts, postsPerPage, onPageChange }) {
  ...
  const handlePrevious = () => {
    console.log("handlePrevious 1---", currentPage);
    if (currentPage > 1) {
      console.log("handlePrevious 2");
      onPageChange(currentPage - 1);
    }
    console.log("handlePrevious 3");
  };

  const handleNext = () => {
    console.log("handleNext - 1---", currentPage, totalPages);
    if (currentPage < totalPages) {
      console.log("handleNext - 2---");
      onPageChange(currentPage + 1);
    }
    console.log("handleNext - 3---");
  };
